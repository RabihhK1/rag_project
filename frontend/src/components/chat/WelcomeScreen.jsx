...
const starterPrompts = [
    {
        ...
        description: "Find the controls that should come first for your organization.",
        prompt: "Which CIS Controls should a 100-person organization prioritize first, and why?",
    },
    {
        title: "Assess a control",
        description: "Review whether an existing security practice is aligned.",
        prompt: "How can I assess whether our multi-factor authentication implementation aligns with CIS Controls?",
    },
    {
        title: "Investigate a gap",
        description: "Identify the safeguards to review after a security event.",
        prompt: "What CIS Controls gaps should we investigate after a phishing incident?",
    },
    {
        title: "Build an implementation plan",
        description: "Turn CIS guidance into a practical, phased roadmap.",
        prompt: "Create a phased CIS Controls implementation plan for a growing organization.",
    },
];
        ...
        <section className="welcome-screen" aria-labelledby="welcome-title">
            <div className="welcome-panel">
                ...
                <div className="welcome-heading">
                    ...
                    <h1 id="welcome-title">Start with the security question that matters.</h1>
                    <p>
                ...
                <div className="starter-prompts" aria-label="Suggested CIS Controls questions">
                    {starterPrompts.map((item) => (
                        ...
                        >
                            ...
                            <ArrowUpRight className="starter-prompt-icon" size={18} aria-hidden="true" />
                        </button>
                    ))}
                </div>

                <ul className="welcome-capabilities" aria-label="Assistant capabilities">
