...
const steps = [
  {
    ...
    description:
      "Start a new chat here, reopen saved conversations, or review feedback analytics.",
    icon: LayoutPanelTop,
  },
  {
    target: "chatViewport",
    ...
    description:
      "Responses stream here. Use inline source numbers such as [1] to preview the supporting CIS content.",
  ...
  },
  {
    ...
    description:
      "Send a question to retrieve a grounded answer. After an answer arrives, you can inspect sources, rate it, or regenerate another version.",
    icon: SendHorizontal,
  },
];
